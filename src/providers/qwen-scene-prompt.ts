...
const BBOX_CONTRACT = "bbox must be [x1,y1,x2,y2] in normalized thousandths from 0 through 1000, where 0 is the top or left edge and 1000 is the bottom or right edge. Coordinates must be integers and x2/y2 must exceed x1/y1. Use corner coordinates, not [x,y,width,height].";
